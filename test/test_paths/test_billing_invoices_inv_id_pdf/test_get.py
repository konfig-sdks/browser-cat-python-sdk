...
from browser_cat_python_sdk.paths.billing_invoices_inv_id_pdf import get
from browser_cat_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestBillingInvoicesInvIdPdf(ApiTestMixin, unittest.TestCase):
    """
    BillingInvoicesInvIdPdf unit test stubs
