...
from browser_cat_python_sdk.pydantic.usage_get_request_data_response_fields import UsageGetRequestDataResponseFields

class UsageGetRequestDataResponse(BaseModel):
    ...
    fields: typing.Optional[UsageGetRequestDataResponseFields] = Field(None, alias='fields')
