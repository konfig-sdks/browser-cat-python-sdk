...
from browser_cat_python_sdk.pydantic.api_keys_update_api_key_response_fields import ApiKeysUpdateApiKeyResponseFields

class ApiKeysUpdateApiKeyResponse(BaseModel):
    ...
    fields: typing.Optional[ApiKeysUpdateApiKeyResponseFields] = Field(None, alias='fields')
