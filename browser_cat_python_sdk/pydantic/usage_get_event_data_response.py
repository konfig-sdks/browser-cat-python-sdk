...
from browser_cat_python_sdk.pydantic.usage_get_event_data_response_fields import UsageGetEventDataResponseFields

class UsageGetEventDataResponse(BaseModel):
    ...
    fields: typing.Optional[UsageGetEventDataResponseFields] = Field(None, alias='fields')
