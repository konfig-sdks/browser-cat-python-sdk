...
from browser_cat_python_sdk.pydantic.api_keys_revoke_key_response_fields import ApiKeysRevokeKeyResponseFields

class ApiKeysRevokeKeyResponse(BaseModel):
    ...
    fields: typing.Optional[ApiKeysRevokeKeyResponseFields] = Field(None, alias='fields')
