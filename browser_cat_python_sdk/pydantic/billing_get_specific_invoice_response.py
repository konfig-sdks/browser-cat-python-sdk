...
from browser_cat_python_sdk.pydantic.billing_get_specific_invoice_response_fields import BillingGetSpecificInvoiceResponseFields

class BillingGetSpecificInvoiceResponse(BaseModel):
    ...
    fields: typing.Optional[BillingGetSpecificInvoiceResponseFields] = Field(None, alias='fields')
