...
from browser_cat_python_sdk.pydantic.api_keys_list_all_response_fields import ApiKeysListAllResponseFields

class ApiKeysListAllResponse(BaseModel):
    ...
    fields: typing.Optional[ApiKeysListAllResponseFields] = Field(None, alias='fields')
