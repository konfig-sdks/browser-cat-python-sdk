...
from browser_cat_python_sdk.pydantic.api_keys_create_api_key_response_fields import ApiKeysCreateApiKeyResponseFields
...
class ApiKeysCreateApiKeyResponse(BaseModel):
    ...
    fields: typing.Optional[ApiKeysCreateApiKeyResponseFields] = Field(None, alias='fields')
