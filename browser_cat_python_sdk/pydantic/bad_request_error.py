...
from browser_cat_python_sdk.pydantic.bad_request_error_fields import BadRequestErrorFields
...
class BadRequestError(BaseModel):
    ...
    fields: typing.Optional[BadRequestErrorFields] = Field(None, alias='fields')
