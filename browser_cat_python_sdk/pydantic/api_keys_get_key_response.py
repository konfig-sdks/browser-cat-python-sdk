...
from browser_cat_python_sdk.pydantic.api_keys_get_key_response_fields import ApiKeysGetKeyResponseFields

class ApiKeysGetKeyResponse(BaseModel):
    ...
    fields: typing.Optional[ApiKeysGetKeyResponseFields] = Field(None, alias='fields')
