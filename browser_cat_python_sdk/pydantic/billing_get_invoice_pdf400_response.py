...
from browser_cat_python_sdk.pydantic.billing_get_invoice_pdf400_response_fields import BillingGetInvoicePdf400ResponseFields

class BillingGetInvoicePdf400Response(BaseModel):
    ...
    fields: typing.Optional[BillingGetInvoicePdf400ResponseFields] = Field(None, alias='fields')
