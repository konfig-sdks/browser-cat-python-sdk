...
from browser_cat_python_sdk.pydantic.usage_list_request_events_response_fields import UsageListRequestEventsResponseFields

class UsageListRequestEventsResponse(BaseModel):
    ...
    fields: typing.Optional[UsageListRequestEventsResponseFields] = Field(None, alias='fields')
