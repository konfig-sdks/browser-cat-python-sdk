...
from browser_cat_python_sdk.pydantic.usage_get_session_range_response_fields import UsageGetSessionRangeResponseFields

class UsageGetSessionRangeResponse(BaseModel):
    ...
    fields: typing.Optional[UsageGetSessionRangeResponseFields] = Field(None, alias='fields')
