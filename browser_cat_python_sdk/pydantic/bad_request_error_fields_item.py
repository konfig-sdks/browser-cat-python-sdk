...
from browser_cat_python_sdk.pydantic.bad_request_error_fields_item_path import BadRequestErrorFieldsItemPath

class BadRequestErrorFieldsItem(BaseModel):
    code: str = Field(alias='code')

    path: BadRequestErrorFieldsItemPath = Field(alias='path')
