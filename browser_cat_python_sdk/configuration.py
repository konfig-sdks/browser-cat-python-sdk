...
from browser_cat_python_sdk.exceptions_base import ApiValueError
from browser_cat_python_sdk.exceptions import ClientConfigurationError
...
conf = browser_cat_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://api.browsercat.com" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if jwt_cookie:
            self.api_key['jwtCookie'] = jwt_cookie
        if key_header:
            self.api_key['keyHeader'] = key_header
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("browser_cat_python_sdk")
