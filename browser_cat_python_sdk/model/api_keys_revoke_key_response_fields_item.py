...
class ApiKeysRevokeKeyResponseFieldsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def path() -> typing.Type['ApiKeysRevokeKeyResponseFieldsItemPath']:
                return ApiKeysRevokeKeyResponseFieldsItemPath
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["path"]) -> 'ApiKeysRevokeKeyResponseFieldsItemPath': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["path"]) -> 'ApiKeysRevokeKeyResponseFieldsItemPath': ...
    ...
    ) -> 'ApiKeysRevokeKeyResponseFieldsItem':
