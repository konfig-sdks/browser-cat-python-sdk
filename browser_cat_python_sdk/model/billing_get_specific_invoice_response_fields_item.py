...
class BillingGetSpecificInvoiceResponseFieldsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def path() -> typing.Type['BillingGetSpecificInvoiceResponseFieldsItemPath']:
                return BillingGetSpecificInvoiceResponseFieldsItemPath
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["path"]) -> 'BillingGetSpecificInvoiceResponseFieldsItemPath': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["path"]) -> 'BillingGetSpecificInvoiceResponseFieldsItemPath': ...
    ...
    ) -> 'BillingGetSpecificInvoiceResponseFieldsItem':
