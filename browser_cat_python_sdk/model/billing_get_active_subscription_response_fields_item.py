...
class BillingGetActiveSubscriptionResponseFieldsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def path() -> typing.Type['BillingGetActiveSubscriptionResponseFieldsItemPath']:
                return BillingGetActiveSubscriptionResponseFieldsItemPath
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["path"]) -> 'BillingGetActiveSubscriptionResponseFieldsItemPath': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["path"]) -> 'BillingGetActiveSubscriptionResponseFieldsItemPath': ...
    ...
    ) -> 'BillingGetActiveSubscriptionResponseFieldsItem':
