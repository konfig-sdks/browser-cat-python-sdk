...
class ApiKeysListAllResponseFieldsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def path() -> typing.Type['ApiKeysListAllResponseFieldsItemPath']:
                return ApiKeysListAllResponseFieldsItemPath
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["path"]) -> 'ApiKeysListAllResponseFieldsItemPath': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["path"]) -> 'ApiKeysListAllResponseFieldsItemPath': ...
    ...
    ) -> 'ApiKeysListAllResponseFieldsItem':
