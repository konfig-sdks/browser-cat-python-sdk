...
class ApiKeysGetKeyResponseFieldsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def path() -> typing.Type['ApiKeysGetKeyResponseFieldsItemPath']:
                return ApiKeysGetKeyResponseFieldsItemPath
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["path"]) -> 'ApiKeysGetKeyResponseFieldsItemPath': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["path"]) -> 'ApiKeysGetKeyResponseFieldsItemPath': ...
    ...
    ) -> 'ApiKeysGetKeyResponseFieldsItem':
